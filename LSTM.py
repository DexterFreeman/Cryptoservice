...
#Prepare and normalise data between -1 and 1
...
for x in range(prediction_days, len(scaled_data)-future_days):
    #Append chucks of 60 days
    # Up until X. Span of 60 starting at x - prediction days.
    x_train.append(scaled_data[x-prediction_days:x, 0])
    #Just append the last day. 
...
#Get the values from before the test dataset and back from the prediction days so we can have the 60 days before that. 
